...
```bash
for skill in ship pr tech-writer deck roadmap diagram monograph handoff plan-init plan-add plan-list plan-update plan-close issue-init issue-new issue-start issue-close; do
