...
1. **Sees what already persists** — checks the project-instructions file (CLAUDE.md in Claude Code, AGENTS.md in Codex), memory files, git state, and whatever tracking docs the repo actually keeps, so it doesn't duplicate existing context
